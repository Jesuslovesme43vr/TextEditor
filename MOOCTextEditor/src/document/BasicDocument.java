...
public class BasicDocument extends Document 
{
	...
	public static void main(String[] args)
	{
		...
		testCase(new BasicDocument("Test One Two Three."), 4, 4, 1);
		testCase(new BasicDocument("Test One Two Three. Test Uno Dos Tres! What test? Are you kidding me:?"), 16, 14, 4);
